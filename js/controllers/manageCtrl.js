...
app.controller("manageCtrl", function ($scope, $rootScope, $location, $window) {
  $scope.videos = [
    ...
    },
    {
      ...
      longDesc: "Streamline data analysis of all sites in your account <ul><li> Generate reports analyzing performance of multiple sites in your account in just a few clicks</li><li>Compare performance of multiple sites at daily, monthly or custom date-range levels</li></ul>", // Video Description
    },
    {
      vidLocation: "-insert-file-name", // Video ID
